...
def compare_circuits(num_wires, params):
    ...
    def mixed_circuit(theta_list):
        ...
        return qml.density_matrix([i for i in range(len(theta_list))])

    # QHACK #

    # DO NOT MODIFY any of the next lines in this scope
    mixed_state = mixed_circuit(params[1])
    pure_state = pure_circuit(params[0])
